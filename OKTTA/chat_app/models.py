...
class Chat(models.Model):
    ...
    manager = models.ForeignKey(Manager, null=True, blank=True, on_delete=models.SET_NULL, related_name='chat_managers')  # Изменено
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='chats')  # Оставлено
